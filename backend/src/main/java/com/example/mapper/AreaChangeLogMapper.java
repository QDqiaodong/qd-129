...
public interface AreaChangeLogMapper {
    ...
    @Insert("INSERT INTO area_change_log_${tableIndex} (desk_chair_id, old_area_id, new_area_id, change_reason, operator) VALUES (#{log.deskChairId}, #{log.oldAreaId}, #{log.newAreaId}, #{log.changeReason}, #{log.operator})")
